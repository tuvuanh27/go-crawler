...
import (
	...
	reflectionHelper "github.com/tuvuanh27/go-crawler/internal/pkg/reflection/reflection-helper"
	"reflect"
)
...
func configProfile(srcType reflect.Type, destType reflect.Type) {
	...
	if destType.Kind() != reflect.Struct {
		log.Errorf("expected reflect.Struct kind for type %s, but got %s", destType.String(), destType.Kind().String())
	}
